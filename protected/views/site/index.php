...
<title>TemplateAccess - A Premium WordPress Theme</title>
...
<div id="header_content">
    <div class="logo">
      <h1><a href="#">TemplateAccess - A Premium WordPress Theme</a></h1>
    </div>
    <!--/logo -->
  <div class="rss">
    <div class="icon"><a href="#"><img src="images/rss_1.gif" alt="picture" width="16" height="16" /></a> <a href="#"><img src="images/rss_2.gif" alt="picture" width="16" height="16" /></a> <a href="#"><img src="images/rss_3.gif" alt="picture" width="16" height="16" /></a> <a href="#"><img src="images/rss_4.gif" alt="picture" width="16" height="16" /></a> <a href="#"><img src="images/rss_5.gif" alt="picture" width="16" height="16" /></a> <a href="#"><img src="images/rss_6.gif" alt="picture" width="16" height="16" /></a></div>
    Just  by My-yiicms weblog.</div>
    <!--/rss -->
    <div class="clr"></div>
    <div class="topnav">
      <ul>
        <li class="current_page_item"><a href="#"><span>首页</span></a></li>
        <li class="page_item page-item-2"><a href="#"><span>关于我们</span></a></li>
        <li class="page_item page-item-3"><a href="#"><span>分类</span></a></li>
      </ul>
      <div class="clr"></div>
    </div>
    <!--/topnav -->
    <form method="get" id="searchform" action="">
      <fieldset id="search">      
        ...
        <input name="searchsubmit" type="image" src="images/search.gif" value="Go" id="searchsubmit" class="btn right" />
        </span>
      </fieldset>
    </form>
    <!--/searchform -->
  ...
  <div id="columns">
    <div id="centercol">
      <div class="box post" id="post-41">
        <div class="content">
          <div class="pic fl"><a href="#" rel="bookmark"><img src="images/img_1.jpg" alt="Post Pic" width="234" height="234" /></a></div>
      	...
      	<ul>
        	<li>
                ...
                <div class="article_info">
                    ...
                    <span class="right">1 条评论 | 编辑</span>
                </div>
    ...
    <div id="rightcol">
      <div class="box">
        ...
        <div class="content">
          <ul class="list">
            <li><a href="#" class="active" rel="tabs_archive">分类</a></li>
            <li><a href="#" rel="tabs_links">文章 </a></li>
            <li><a href="#" rel="tabs_meta" class="last">其他</a></li>
          </ul>
          <div class="tabs_archive tabs_list">
            <ul class="sf-menu sf-js-enabled">
              <li class="cat-item cat-item-8"><a href="#" >关于我们</a> </li>
              <li class="cat-item cat-item-1"><a href="#">分类</a>
                <ul class='children'>
                  <li class="cat-item cat-item-5"><a href="#">分类1</a> </li>
                  <li class="cat-item cat-item-3"><a href="#">分类2</a> </li>
                  <li class="cat-item cat-item-4"><a href="#">分类3</a>
                    <ul class='children'>
                      <li class="cat-item cat-item-12"><a href="#">分类33</a> </li>
                    </ul>
                  </li>
                </ul>
              </li>
          ...
          <div class="tabs_links tabs_list">
            <ul>
              <li><a href="#" rel="bookmark">Привет, мир!</a></li>
              <li><a href="#" rel="bookmark">Детали</a></li>
            </ul>
          </div>
          <!-- Start Meta -->
...
<div id="page_bottom">
  <div id="footer">
    <div class="clr"></div>
    <div class="text">&copy; Copyright 2011 | Powered by My Yiicms </div>
